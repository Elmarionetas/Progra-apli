...
connection = psycopg2.connect(
        ...
        user='postgres',
        password='1962',
        database='SCRUMBASE'   #antes aplicada
    )
...
go_register_label = tk.Label(login_contentframe, text=">> Por favor, Regístrese" , font=('Orbitron',10), bg=bgcolor, fg='black')
...
document_label_rg = tk.Label(register_contentframe, text='Documento:', font=('Orbitron',14), bg=bgcolor)
...
document_entry_rg = tk.Entry(register_contentframe, font=('Orbitron', 14), width=22)
...
document_label_rg.grid(row=7, column=0, pady=5, sticky='e')
document_entry_rg.grid(row=7, column=1)
...
def register():
    ...
    if len(fullname) > 0 and  len(username) > 0 and len(password) > 0 and len(phone) > 0:
        if check_username(username) == False: 
            if password:
                vals = (document, fullname, username, password, phone, surname, gdr, email)
...
class sb:
    ...
    def __init__(self, master):
        ...
        self.volCua =tk.Frame (self.master, highlightbackground='#ECDAFB', highlightcolor='#ECDAFB', highlightthickness=2, bg='#ECDAFB', width=450, height=800)
        self.volframe = tk.Frame (self.DoneCua, bg='#9E91E9', padx=1, pady=1)
        self.vol = tk.Button (self.Doneframe, text= 'VOLVER', padx=50, pady=5, fg='black', font=('Orbitron',20), width=10)
        self.volCua.pack()
        self.volframe.pack()
        self.vol.pack()
...
#        )
     #   c=py_login_register_form.connection.cursor()
        ...
        #consulta2 = "consultasss"
        #consulta2=c.execute(select_query)
        #connection.commit()
        #onnection.commit()
        #self.ToDoEspa = tk.Frame (self.ToDoCua, bg='#9E91E9', padx=1, pady=1)
        #self.ToDoEspa1 = tk.Label (self.ToDoEspa, text= ' HISTORIA DE ECM ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        ...
        self.header = tk.Frame (self.master, highlightbackground='#9E91E9', highlightcolor='#9E91E9', highlightthickness=2, bg='#9E91E9', width=ws, height=70)
        self.titleframe = tk.Frame(self.header, bg='#9E91E9', padx=1, pady=1)
        self.lbl = tk.Label(self.titleframe, text=' SCRUM BOARD ', padx=50, pady=5, fg='black', font=('Orbitron',20), width=10)
        self.header.pack()
        self.titleframe.pack()
        self.lbl.pack()
        self.titleframe.place(rely=0.5, relx=0.5, anchor=CENTER)
        ...
        # -------- TO DO ------------- #
#antes consulta en vez de record
        ...
        self.ToDoEspa = tk.Frame (self.ToDoCua, bg='#9E91E9', padx=1, pady=1)
        self.ToDoEspa1 = tk.Label (self.ToDoEspa, text= (record), padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.ToDoEspa2 = tk.Frame (self.ToDoCua, bg='#9E91E9', padx=1, pady=1)
        self.ToDoEspa3 = tk.Label (self.ToDoEspa2, text= ' HISTORIA DE USUARIO 2 ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.ToDoCua.pack()
        self.ToDoframe.pack()
        self.toDo.pack()
        self.ToDoEspa.pack()
...
class progress:
    ...
    def __init__(self, master):
        ...
        self.InProframe = tk.Frame (self.InProCua, bg='#9E91E9', padx=1, pady=1)
        self.InPro = tk.Label (self.InProframe, text= ' PROGRESS ', padx=50, pady=5, fg='black', font=('Orbitron',20), width=10)
        self.InProEspa = tk.Frame (self.InProCua, bg='#9E91E9', padx=1, pady=1)
        self.InProEspa1 = tk.Label (self.InProEspa, text= ' EN PROGRESO 1 ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.InProEspa2 = tk.Frame (self.InProCua, bg='#9E91E9', padx=1, pady=1)
        self.InProEspa3 = tk.Label (self.InProEspa2, text= ' EN PROGRESO 2 ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.InProCua.pack()
        self.InProframe.pack()
        self.InPro.pack()
        self.InProEspa.pack()
...
class done:
    ...
    def __init__(self, master):
        ...
        self.DoneCua =tk.Frame (self.master, highlightbackground='#ECDAFB', highlightcolor='#ECDAFB', highlightthickness=2, bg='#ECDAFB', width=ws-250, height=800)
        self.Doneframe = tk.Frame (self.DoneCua, bg='#9E91E9', padx=1, pady=1)
        self.Done = tk.Label (self.Doneframe, text= ' DONE ', padx=50, pady=5, fg='black', font=('Orbitron',20), width=10)
        self.DoneEspa = tk.Frame (self.DoneCua, bg='#9E91E9', padx=1, pady=1)
        self.DoneEspa1 = tk.Label (self.DoneEspa, text= ' TERMINADO 1 ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.DoneEspa2 = tk.Frame (self.DoneCua, bg='#9E91E9', padx=1, pady=1)
        self.DoneEspa3 = tk.Label (self.DoneEspa2, text= ' TERMINADO 2 ', padx=150, pady=150, fg='black', font=('Orbitron',20), width=10)
        self.DoneCua.pack()
        self.Doneframe.pack()
        self.Done.pack()
        self.DoneEspa.pack()
